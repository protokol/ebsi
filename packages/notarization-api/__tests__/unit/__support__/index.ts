...
import { Handlers as NotarizationHandlers } from "@protokol/notarization-transactions";
...
export const initApp = (): Application => {
	...
	app.bind(Container.Identifiers.TransactionHandler).to(NotarizationHandlers.NotarizationTransactionHandler);
